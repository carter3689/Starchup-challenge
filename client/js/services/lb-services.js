      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/orders/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Business.orders.update() instead.
            "::update::Business::orders": {
              url: urlBase + "/businesses/:id/orders",
              method: "PUT",
            },

            // INTERNAL. Use Business.orders.destroy() instead.
            "::destroy::Business::orders": {
              url: urlBase + "/businesses/:id/orders",
              method: "DELETE",
            },
          }
     ...
     */
        ...
        R.orders.createMany = function() {
          ...
          return action.apply(R, arguments);
            ...
            /**
             * @ngdoc method
             * @name lbServices.Business.orders#destroy
             * @methodOf lbServices.Business.orders
             *
             * @description
             *
        ...
        R.orders.destroy = function() {
          var TargetResource = $injector.get("Order");
          var action = TargetResource["::destroy::Business::orders"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Business.orders#update
             * @methodOf lbServices.Business.orders
             *
             * @description
             *
        ...
        R.orders.update = function() {
          var TargetResource = $injector.get("Order");
          var action = TargetResource["::update::Business::orders"];
          return action.apply(R, arguments);
        };
